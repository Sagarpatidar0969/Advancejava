...
public abstract class FilterConnection implements Connection
{
	...
	public void setShardingKey(ShardingKey a) throws SQLException
	{
		inner.setShardingKey(a);
	}
	
	public void setShardingKey(ShardingKey a, ShardingKey b) throws SQLException
	{
	...
	public boolean setShardingKeyIfValid(ShardingKey a, ShardingKey b, int c) throws SQLException
	{
		return inner.setShardingKeyIfValid(a, b, c);
	}
	
	public boolean setShardingKeyIfValid(ShardingKey a, int b) throws SQLException
	{
