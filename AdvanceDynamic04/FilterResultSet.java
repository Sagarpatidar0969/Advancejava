...
public abstract class FilterResultSet implements ResultSet
{
	...
	public void updateObject(int a, Object b, SQLType c, int d) throws SQLException
	{
		inner.updateObject(a, b, c, d);
	}
	
	public void updateObject(int a, Object b, SQLType c) throws SQLException
	{
		inner.updateObject(a, b, c);
	}
	
	public void updateObject(String a, Object b, SQLType c, int d) throws SQLException
	{
		inner.updateObject(a, b, c, d);
	}
	
	public void updateObject(String a, Object b, SQLType c) throws SQLException
	{
		inner.updateObject(a, b, c);
	}
